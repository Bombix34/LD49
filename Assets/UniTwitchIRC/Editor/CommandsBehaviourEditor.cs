...
namespace UniTwitchIRCEditor
{
    ...
    public class CommandsBehaviourEditor : Editor
    {
        ...
        RepliesSetReorderableList m_BaseCommandsReorderableList;
        ...
        void OnEnable()
        {
            ...
            m_BaseCommandsReorderableList = new RepliesSetReorderableList(
                    serializedObject,
                    serializedObject.FindProperty("m_BaseCommands"),
                    "Base Command: Zero or more parameters"
                    );       
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            m_BaseCommandsReorderableList.OnInspectorGUI();
